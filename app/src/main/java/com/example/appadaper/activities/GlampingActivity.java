...
public class GlampingActivity extends AppCompatActivity implements itemAdapter.OnItemActionListener, Serializable {
    ...
    private void initItems() {
        ...
        items.add(new ReservaGlamping(101, "María González", "2024-06-15", "2024-06-20", 1200, false, "#2E7D32",
                "https://media.admagazine.com/photos/6239341e83e0740e83d095a3/16:9/w_5488,h_3087,c_limit/glamping.jpg",50, true, 4, "Lujo en la naturaleza", "Senderismo, Observación de estrellas"));

        items.add(new ReservaGlamping(202, "Carlos Mendoza", "2024-07-01", "2024-07-05", 1800, true, "#388E3C",
                "https://www.campingelpino.com/wp-content/uploads/2023/11/que-es-el-glamping-caracteristicas-scaled.jpg",65, true, 6, "Aventura familiar", "Talleres naturales, Paseos a caballo"));

        items.add(new ReservaGlamping(303, "Ana López", "2024-08-10", "2024-08-15", 1500, false, "#689F38",
                "https://visitarmedellin.com/wp-content/uploads/2023/06/bubble-sky-glamping.jpg",45, false, 2, "Romántico", "Cena bajo las estrellas, Masajes"));

        items.add(new ReservaGlamping(404, "Roberto Sánchez", "2024-09-12", "2024-09-15", 950, true, "#7CB342",
                "https://blog.winesofargentina.com/wp-content/uploads/2021/11/Glamping-APERTURA.jpg",35, false, 3, "Económico", "Yoga matutino, Fogata nocturna"));

        items.add(new ReservaGlamping(505, "Laura Jiménez", "2024-10-20", "2024-10-25", 2100, false, "#33691E",
                "https://theindianface.com/cdn/shop/articles/Sin-titulo-1_11661747-7518-44c0-b923-111d1cdc5f78.jpg?v=1652867285",80, true, 5, "Premium", "Tour gastronómico, Spa natural, Clases de fotografía"));
    }
